...
Rails.application.configure do
  ...
  # Store uploaded files in PostgreSQL, matching production (see config/storage.yml).
  config.active_storage.service = :db

  # Don't care if the mailer can't send.
  config.action_mailer.raise_delivery_errors = false

  # Development never sends real mail. letter_opener pops each message straight
