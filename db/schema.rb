...
ActiveRecord::Schema[8.0].define(version: 2026_08_12_130921) do
  ...
  create_table "spree_products", id: :serial, force: :cascade do |t|
    ...
    t.integer "b2b_product_id"
    t.index ["available_on"], name: "index_spree_products_on_available_on"
    t.index ["b2b_product_id"], name: "index_spree_products_on_b2b_product_id", unique: true
